...
namespace BC.Intranet
{
    ...
    public class ApplicationUserManager : UserManager<User, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStoreService(BillionCompanyDbContext.Create()));
            manager.PasswordHasher = new BCPasswordHasher();
            // Configure validation logic for usernames
            manager.UserValidator = new CustomUserValidator<User>();
